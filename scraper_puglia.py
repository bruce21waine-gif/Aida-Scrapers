# -*- coding: utf-8 -*-
"""Codice Python per Scraper Regione Puglia (v5.4 - Robusto)

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1jImPC_4llxDAsnfGd15Q-xkPhIKM9N0a
"""

# -*- coding: utf-8 -*-

# --- Scraper per "Bonus Facile" - Versione 5.4 (Regione Puglia Robusto) ---
# Obiettivo: Estrarre i bandi dal portale della Regione Puglia in modo rapido e affidabile.
# Correzione: Aggiunta una logica di retry alla connessione del database e aumentato
# il timeout per le richieste HTTP per gestire errori di rete temporanei.
#
...
def connect_to_db():
    ...
    """
    # --- MODIFICA CHIAVE v5.4: Logica di Retry ---
    attempts = 3
...
def find_sitemap_url_from_robots(robots_url):
    ...
    try:
        ...
        # --- MODIFICA CHIAVE v5.4: Timeout aumentato ---
        response = requests.get(robots_url, headers=headers, timeout=45)
...
def scrape_regione_puglia():
    ...
    """
    print("--- Avvio scraper per Regione Puglia (v5.4 - Robusto) ---")
