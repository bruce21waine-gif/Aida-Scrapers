# -*- coding: utf-8 -*-
"""Codice Python per Scraper Regione Puglia (v5.5 - Robusto)

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1KblUIlhu7emlDOMEUwQo51AkG10PEtY9
"""

# -*- coding: utf-8 -*-

# --- Scraper per "Bonus Facile" - Versione 5.5 (Regione Puglia Robusto) ---
# Obiettivo: Estrarre i bandi dal portale della Regione Puglia in modo rapido e affidabile.
# Correzione: Aggiunta una logica di retry alle richieste HTTP per gestire
# i timeout di connessione e aumentato il timeout generale.
#
    ...
    for i in range(attempts):
        try:
            ...
            if i < attempts - 1:
                ...
                raise e # Solleva l'eccezione dopo l'ultimo tentativo
    return None
...
def find_sitemap_url_from_robots(robots_url):
    ...
    try:
        response = make_request_with_retry(robots_url, timeout=90)
...
def scrape_regione_puglia():
    ...
    """
    print("--- Avvio scraper per Regione Puglia (v5.5 - Robusto) ---")
    print("Strategia: Sitemap + Filtro Positivo + Retry HTTP.")
