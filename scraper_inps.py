# -*- coding: utf-8 -*-
"""Scraper INPS v5.1 (Intelligente con Correzione DSN)

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/193D1z55Y9TI4D_o9v-LohAf33B7mr89m
"""

# -*- coding: utf-8 -*-

# --- Scraper per "Bonus Facile" - Versione 5.1 (Correzione DSN) ---
# Obiettivo: Estrarre i dettagli (ISEE, età) dalle pagine dei bonus.
# Correzione: Aggiunta una logica di pulizia della stringa di connessione (DSN)
# per risolvere l'errore "invalid connection option" che si verifica su GitHub Actions.
#
...
def connect_to_db():
    ...
    """
    try:
        # --- MODIFICA CHIAVE v5.1: Pulizia della stringa di connessione ---
        db_url = os.getenv("DATABASE_URL")
        if not db_url:
            print("Errore: La variabile d'ambiente DATABASE_URL non è impostata.")
            return None

        # Se la stringa contiene "DATABASE_URL=", la pulisce.
        # Utile per ambienti come GitHub Actions.
...
def scrape_inps_bandi():
    ...
    """
    print("--- Avvio scraper per INPS (v5.1) ---")
